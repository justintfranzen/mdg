...
class DSM_Circle_Info_Child extends ET_Builder_Module {
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$circle_info_item_content       = sprintf(
			...
			$order_class,
			'content' === $this->props['dsm_content_type'] ? '' === $this->props['header_level'] ? sprintf( '<%2$s class="dsm-title">%1$s</%2$s>', $this->props['dsm_content_title'], $parent_header_level ) : sprintf( '<%2$s class="dsm-title">%1$s</%2$s>', $this->props['dsm_content_title'], $this->props['header_level'] ) : '',
			'content' === $this->props['dsm_content_type'] ? $content : '',
